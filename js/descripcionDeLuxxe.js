...
btnUnaHabitacion.addEventListener('click', () => {
    ...
    btnVerificarUna.addEventListener('click', async () => {
        const habitaciones = await buscarDocumentosPorCampo("habitacionesDeLuxxeGrandMayan", "habitacion", "una habitacion");
...
btnReservarUna.addEventListener('click',async () => {
    ...
    if (habitacionDisponible) {
        habitacionDisponible.hotel ='habitacionesDeLuxxeGrandMayan';
...
btnDosHabitaciones.addEventListener('click', () => {
    ...
    btnVerificarDos.addEventListener('click', async () => {
        const habitaciones = await buscarDocumentosPorCampo("habitacionesDeLuxxeGrandMayan", "habitacion", "dos habitaciones");
        const disponibles = habitaciones.filter(habitacion => habitacion.estado === "disponible").length;
...
btnTresHabitaciones.addEventListener('click', () => {
    ...
    btnVerificarTres.addEventListener('click', async () => {
        const habitaciones = await buscarDocumentosPorCampo("habitacionesDeLuxxeGrandMayan", "habitacion", "tres habitaciones");
        const disponibles = habitaciones.filter(habitacion => habitacion.estado === "disponible").length;
        console.log(disponibles);
...
btnCuatroHabitaciones.addEventListener('click', () => {
    ...
    btnVerificarCuatro.addEventListener('click', async () => {
        const habitaciones = await buscarDocumentosPorCampo("habitacionesDeLuxxeGrandMayan", "habitacion", "cuatro habitaciones");
        const disponibles = habitaciones.filter(habitacion => habitacion.estado === "disponible").length;
        console.log(disponibles);
